...
object DestinasiHomePesanan : DestinasiNavigasi {
    override val route = "pesanan_home"
    override val titleRes = R.string.app_name
}

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun HomeScreenPesanan(
    ...
    Scaffold(
        modifier = modifier.nestedScroll(scrollBehavior.nestedScrollConnection), topBar = {
            PesananTopAppBar(
                title = stringResource(id = DestinasiHomePesanan.titleRes),
